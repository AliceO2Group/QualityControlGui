  ...
  render() {
    ...
    function sidebarMine() {
      return html`<div>
          ...
          <div class="sidebar-menu-item" onclick=${e => model.router.go('/a/collections')}>
            ...
            Collections</div>
          <div class="sidebar-menu-item" onclick=${e => model.router.go('/a/objects')}>
          ...
          <div class="sidebar-menu-item" onclick=${e => model.set('route', model.ROUTE_SHOW_COLLECTION)}>
            <svg viewBox="0 0 8 8" class="icon" fill="currentcolor"><path d="M0 0v4h4v-4h-4zm5 2v3h-3v1h4v-4h-1zm2 2v3h-3v1h4v-4h-1z" id="layers" /></svg>
            Test</div>
          <div class="sidebar-menu-item" onclick=${e => model.set('route', model.ROUTE_SHOW_COLLECTION)}>
            <svg viewBox="0 0 8 8" class="icon" fill="currentcolor"><path d="M0 0v4h4v-4h-4zm5 2v3h-3v1h4v-4h-1zm2 2v3h-3v1h4v-4h-1z" id="layers" /></svg>
...
customElements.define('qc-sidebar', QCGSidebar);

function Toto() {
  return html`<b>toto</b>`;
}
